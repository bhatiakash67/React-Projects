              ...
              <div className="car-cards3">
                ...
                <Link to="../car-details" >
                  <div className="recent-car1">
                    ...
                    <img className="car-cardimage3" src={Car1} alt="Car" style={{width: '272px', height: '84px', marginTop: '70px', marginLeft: '22px'}} />
                ...
                <Link to="../car-details" >
                  <div className="recent-car2">
                    ...
                    <p className='car-type3'>Sport</p>
                    <img className="car-cardimage3" src={Car2} alt="Car" style={{width: '228px', height: '72px', marginTop: '80px', marginLeft: '44px'}} />
                    <div className="carspecs3">
                      <img className="gas-station3" src={GasStation} alt="Petrol Tank" />
                ...
                <Link to="../car-details" >
                  <div className="recent-car3">
                    ...
                    <img className="car-cardimage3" src={Car3} alt="Car" style={{width: '244px', height: '76px', marginTop: '78px', marginLeft: '36px'}} />
                    <div className="carspecs3">
                      <img className="gas-station3" src={GasStation} alt="Petrol Tank" />
              ...
              <div className="car-cards3">
                <Link to="../car-details">
                  <div className="recent-car1">
                    ...
                    <img className="car-cardimage3" src={Car4} alt="Car" style={{width: '252px', height: '112px', marginTop: '40px', marginLeft: '32px'}} />
                    <div className="carspecs3">
                      <img className="gas-station3" src={GasStation} alt="Petrol Tank" />
                      <p className='fuel3'>70L</p>
                      <img className="wheel3" src={Steering} alt="Steering Wheel" />
                ...
                <Link to="../car-details">
                  <div className="recent-car2">
                    ...
                    <p className='car-type3'>SUV</p>
                    <img className="car-cardimage3" src={Car5} alt="Car" style={{width: '254px', height: '102px', marginTop: '50px', marginLeft: '31px'}} />
                    <div className="carspecs3">
                      <img className="gas-station3" src={GasStation} alt="Petrol Tank" />
                      <p className='fuel3'>80L</p>
                      <img className="wheel3" src={Steering} alt="Steering Wheel" />
                ...
                <Link to="../car-details">
                  <div className="recent-car3">
                    ...
                    <p className='car-type3'>SUV</p>
                    <img className="car-cardimage3" src={Car6} alt="Car" style={{width: '252px', height: '112px', marginTop: '40px', marginLeft: '32px'}} />
                    <div className="carspecs3">
                      <img className="gas-station3" src={GasStation} alt="Petrol Tank" />
                      <p className='fuel3'>90L</p>
                      <img className="wheel3" src={Steering} alt="Steering Wheel" />
